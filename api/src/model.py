...
class Mission(Document):
    ...
    def compute_etats_financiers(self, efi):
        ...
        for section in ("actif", "passif", "pnl"):
            ...
            if section == "actif":
                ...
                # ("AI", ["AJ","AK","AL","AM","AN"])
                # AP reste affichée comme ligne distincte, mais exclue des agrégats.
    ...
    def prod_efi(self, balance_n, balance_n1, balance_variation):
        ...
        # Recalcul des lignes agrégées (AD, AI, AZ, CP, DZ, etc.)
        # à partir des lignes feuilles pour garantir des formules cohérentes.
        datum = self.compute_etats_financiers(datum)
